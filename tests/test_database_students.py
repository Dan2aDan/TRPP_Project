...
def test_register_student(database_students, database_teachers):
...
def test_get_student_by_id(database_students, database_teachers):
    teacher = database_teachers.register_teacher("12", "1")
...
def test_update_student(database_students, database_teachers):
    teacher = database_teachers.register_teacher("12", "1")
...
def test_delete_student(database_students, database_teachers):
    teacher = database_teachers.register_teacher("12", "1")
